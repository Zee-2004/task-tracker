  ...
  return (
    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
      <div className="bg-white rounded-2xl p-5 shadow-sm border border-gray-100">
        <p className="text-xs font-medium text-gray-500 uppercase tracking-wide">To Do</p>
      ...
      <div className="bg-white rounded-2xl p-5 shadow-sm border border-gray-100">
        <p className="text-xs font-medium text-gray-500 uppercase tracking-wide">Done</p>
      ...
      <div className="bg-gradient-to-br from-red-500 to-rose-600 rounded-2xl p-5 shadow-sm text-white">
        <p className="text-xs font-medium uppercase tracking-wide opacity-90">Overdue</p>
